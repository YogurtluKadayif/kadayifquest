...
public class GuiOduncu {
    ...
    public GuiOduncu(Player player) {
        this.inventory = Inventory.builder()
                ...
                .listener(ClickInventoryEvent.class, (ClickInventoryEvent event) -> {
                    ...
                    for (SlotTransaction slotTransaction : event.getTransactions()) {
                        ...
                        /* Acemi Oduncu */
                        if (affected.getType() == Items.WOODEN_AXE) {
                            try {
                                ...
                                try {
                                    ...
                                    if (rsara.next()) {
                                        if (rsara.getString("oduncu").equals("baslamadi")) {
                                            if(rsara.getString("gorev1").equals("yok") || rsara.getString("gorev2").equals("yok")) {
                                                if(rsara.getString("gorev1").equals("yok")) {
                                                    String sql = "UPDATE Gorev SET oduncu=?, gorev1='oduncu', gorev1durum=? WHERE oyuncu='" + player.getName() + "'";
                                                    PreparedStatement ps = connect.prepareStatement(sql);
                                                    ps.setString(1, "g1devam");
                                                    ps.setInt(2, 0);
                                                    ps.executeUpdate();
                                                    Yogurtlugorev.gg.get(uuid).put("gorev1durum:", "0");
                                                    player.sendMessage(Text.of(TextColors.BLUE, "[", TextColors.AQUA, "kadayifQuest", TextColors.BLUE, "] ", TextColors.DARK_RED, "Acemi Oduncu gorevine basladiniz."));
                                                } else {
                                                    if(rsara.getString("gorev2").equals("yok")) {
                                                        String sql = "UPDATE Gorev SET oduncu=?, gorev2='oduncu', gorev2durum=? WHERE oyuncu='" + player.getName() + "'";
                                                        PreparedStatement ps = connect.prepareStatement(sql);
                                                        ps.setString(1, "g1devam");
                                                        ps.setInt(2, 0);
                                                        ps.executeUpdate();
                            ...
                            /* Tecrübeli Oduncu */
                            if (affected.getType() == Items.IRON_AXE) {
                                try {
                                    connect = DriverManager.getConnection(DB_URL, USER, PASS);
                                    statmt = connect.createStatement();
                                    try {
                                        ...
                                        ResultSet rsara = statmt.executeQuery(sqlara);
                                        if (rsara.next()) {
                                            if (rsara.getString("oduncu").equals("g1bitti")) {
                                                if(rsara.getString("gorev1").equals("yok") || rsara.getString("gorev2").equals("yok")) {
                                                    if(rsara.getString("gorev1").equals("yok")) {
                                                        String sql = "UPDATE Gorev SET oduncu=?, gorev1='oduncu', gorev1durum=? WHERE oyuncu='" + player.getName() + "'";
                                                        PreparedStatement ps = connect.prepareStatement(sql);
                                                        ...
                                                        ps.executeUpdate();
                                                        Yogurtlugorev.gg.get(uuid).put("gorev1durum:", "0");
                                                        player.sendMessage(Text.of(TextColors.BLUE, "[", TextColors.AQUA, "kadayifQuest", TextColors.BLUE, "] ", TextColors.DARK_RED, "Tecrubeli Oduncu gorevine basladiniz."));
                                                    } else {
                                                        if(rsara.getString("gorev2").equals("yok")) {
                                                            String sql = "UPDATE Gorev SET oduncu=?, gorev2='oduncu', gorev2durum=? WHERE oyuncu='" + player.getName() + "'";
                                                            PreparedStatement ps = connect.prepareStatement(sql);
                                ...
                                /* Bilgili Oduncu */
                                if (affected.getType() == Items.GOLDEN_AXE) {
                                    try {
                                        connect = DriverManager.getConnection(DB_URL, USER, PASS);
                                        statmt = connect.createStatement();
                                        try {
                                            ...
                                            ResultSet rsara = statmt.executeQuery(sqlara);
                                            if (rsara.next()) {
                                                if (rsara.getString("oduncu").equals("g2bitti")) {
                                                    if(rsara.getString("gorev1").equals("yok") || rsara.getString("gorev2").equals("yok")) {
                                                        if(rsara.getString("gorev1").equals("yok")) {
                                                            String sql = "UPDATE Gorev SET oduncu=?, gorev1='oduncu', gorev1durum=? WHERE oyuncu='" + player.getName() + "'";
                                                            PreparedStatement ps = connect.prepareStatement(sql);
                                                            ...
                                                            ps.executeUpdate();
                                                            Yogurtlugorev.gg.get(uuid).put("gorev1durum:", "0");
                                                            player.sendMessage(Text.of(TextColors.BLUE, "[", TextColors.AQUA, "kadayifQuest", TextColors.BLUE, "] ", TextColors.DARK_RED, "Bilgili Oduncu gorevine basladiniz."));
                                                        } else {
                                                            if(rsara.getString("gorev2").equals("yok")) {
                                                                String sql = "UPDATE Gorev SET oduncu=?, gorev2='oduncu', gorev2durum=? WHERE oyuncu='" + player.getName() + "'";
                                                                PreparedStatement ps = connect.prepareStatement(sql);
                                    ...
                                    if (affected.getType() == Items.DIAMOND_AXE) {
                                        try {
                                            ...
                                            try {
                                                ...
                                                ResultSet rsara = statmt.executeQuery(sqlara);
                                                if (rsara.next()) {
                                                    if (rsara.getString("oduncu").equals("g3bitti")) {
                                                        if(rsara.getString("gorev1").equals("yok") || rsara.getString("gorev2").equals("yok")) {
                                                            if(rsara.getString("gorev1").equals("yok")) {
                                                                String sql = "UPDATE Gorev SET oduncu=?, gorev1='oduncu', gorev1durum=? WHERE oyuncu='" + player.getName() + "'";
                                                                PreparedStatement ps = connect.prepareStatement(sql);
                                                                ...
                                                                ps.executeUpdate();
                                                                Yogurtlugorev.gg.get(uuid).put("gorev1durum:", "0");
                                                                player.sendMessage(Text.of(TextColors.BLUE, "[", TextColors.AQUA, "kadayifQuest", TextColors.BLUE, "] ", TextColors.DARK_RED, "Usta Oduncu gorevine basladiniz."));
                                                            } else {
                                                                if(rsara.getString("gorev2").equals("yok")) {
                                                                    String sql = "UPDATE Gorev SET oduncu=?, gorev2='oduncu', gorev2durum=? WHERE oyuncu='" + player.getName() + "'";
                                                                    PreparedStatement ps = connect.prepareStatement(sql);
        ...
        try {
            ...
            try {
                ...
                if(rsara.next()) {
                    // başlamadı
                    if(rsara.getString("oduncu").equals("baslamadi")) {
                        setItem(1,0,1,"baslamadi","woodenaxe");
                        setItem(3,0,0,"baslamadi","ironaxe");
                        setItem(5,0,0,"baslamadi","goldenaxe");
                        setItem(7,0,0,"baslamadi","diamondaxe");
                    } else {
                        // Acemi Oduncu - devam ediyor
                        if(rsara.getString("oduncu").equals("g1devam")) {
                            setItem(1,0,1,"basladi","woodenaxe");
                            setItem(3,0,0,"baslamadi","ironaxe");
                            setItem(5,0,0,"baslamadi","goldenaxe");
                            setItem(7,0,0,"baslamadi","diamondaxe");
                        } else {
                            // Acemi Oduncu bitti
                            if(rsara.getString("oduncu").equals("g1bitti")) {
                                setItem(1,0,1,"bitirdi","woodenaxe");
                                setItem(3,0,1,"baslamadi","ironaxe");
                                setItem(5,0,0,"baslamadi","goldenaxe");
                                setItem(7,0,0,"baslamadi","diamondaxe");
                            } else {
                                // Tecrübeli Oduncu devam ediyor
                                if(rsara.getString("oduncu").equals("g2devam")) {
                                    setItem(1,0,1,"bitirdi","woodenaxe");
                                    setItem(3,0,1,"basladi","ironaxe");
                                    setItem(5,0,0,"baslamadi","goldenaxe");
                                    setItem(7,0,0,"baslamadi","diamondaxe");
                                } else {
                                    // Tecrübeli Oduncu bitti
                                    if(rsara.getString("oduncu").equals("g2bitti")) {
                                        setItem(1,0,1,"bitirdi","woodenaxe");
                                        setItem(3,0,1,"bitirdi","ironaxe");
                                        setItem(5,0,1,"baslamadi","goldenaxe");
                                        setItem(7,0,0,"baslamadi","diamondaxe");
                                    } else {
                                        // Bilgili Oduncu devam ediyor
                                        if(rsara.getString("oduncu").equals("g3devam")) {
                                            setItem(1,0,1,"bitirdi","woodenaxe");
                                            setItem(3,0,1,"bitirdi","ironaxe");
                                            setItem(5,0,1,"basladi","goldenaxe");
                                            setItem(7,0,0,"baslamadi","diamondaxe");
                                        } else {
                                            // Bilgili Oduncu bitti
                                            if(rsara.getString("oduncu").equals("g3bitti")) {
                                                setItem(1,0,1,"bitirdi","woodenaxe");
                                                setItem(3,0,1,"bitirdi","ironaxe");
                                                setItem(5,0,1,"bitirdi","goldenaxe");
                                                setItem(7,0,1,"baslamadi","diamondaxe");
                                            } else {
                                                // Usta Oduncu devam ediyor
                                                if(rsara.getString("oduncu").equals("g4devam")) {
                                                    setItem(1,0,1,"bitirdi","woodenaxe");
                                                    setItem(3,0,1,"bitirdi","ironaxe");
                                                    setItem(5,0,1,"bitirdi","goldenaxe");
                                                    setItem(7,0,1,"basladi","diamondaxe");
                                                } else {
                                                    // Usta Oduncu bitti
                                                    if(rsara.getString("oduncu").equals("g4bitti")) {
                                                        setItem(1,0,1,"bitirdi","woodenaxe");
                                                        setItem(3,0,1,"bitirdi","ironaxe");
                                                        setItem(5,0,1,"bitirdi","goldenaxe");
                                                        setItem(7,0,1,"bitirdi","diamondaxe");
                                                    }
                                                }
                                            }
                                        }
    ...
    public void setItem(Integer x, Integer y, Integer visin, String gorevdurum, String item) {
        ...
        /* Acemi Oduncu */
        if(item.equals("woodenaxe")) {
            if(visin == 1) {
                if(gorevdurum.equals("basladi")) {
                    inventory.query(SlotPos.of(x, y)).set(ItemStack.builder()
                            .from(ItemStack.of((ItemType) Items.WOODEN_AXE))
                            .add(Keys.DISPLAY_NAME, Text.of(TextColors.WHITE, "Acemi Oduncu"))
                            .add(Keys.ITEM_LORE, Arrays.asList(
                                    Text.of(TextColors.AQUA, "16 odun kaz."),
            ...
            /* Tecrübeli Oduncu */
            if(item.equals("ironaxe")) {
                if(visin == 1) {
                    if(gorevdurum.equals("basladi")) {
                        inventory.query(SlotPos.of(x, y)).set(ItemStack.builder()
                                .from(ItemStack.of((ItemType) Items.IRON_AXE))
                                .add(Keys.DISPLAY_NAME, Text.of(TextColors.BLUE, "Tecrubeli Oduncu"))
                                .add(Keys.ITEM_LORE, Arrays.asList(
                                        Text.of(TextColors.AQUA, "32 odun kaz."),
                                        Text.of(TextColors.GREEN, "Oduller:"),
                ...
                /* Bilgili Oduncu */
                if(item.equals("goldenaxe")) {
                    if(visin == 1) {
                        if(gorevdurum.equals("basladi")) {
                            inventory.query(SlotPos.of(x, y)).set(ItemStack.builder()
                                    .from(ItemStack.of((ItemType) Items.GOLDEN_AXE))
                                    .add(Keys.DISPLAY_NAME, Text.of(TextColors.YELLOW, "Bilgili Oduncu"))
                                    .add(Keys.ITEM_LORE, Arrays.asList(
                                            Text.of(TextColors.AQUA, "64 odun kaz."),
                                            Text.of(TextColors.GREEN, "Oduller:"),
                    ...
                    /* Usta Oduncu */
                    if(item.equals("diamondaxe")) {
                        if(visin == 1) {
                            if(gorevdurum.equals("basladi")) {
                                inventory.query(SlotPos.of(x, y)).set(ItemStack.builder()
                                        .from(ItemStack.of((ItemType) Items.DIAMOND_AXE))
                                        .add(Keys.DISPLAY_NAME, Text.of(TextColors.LIGHT_PURPLE, "Usta Oduncu"))
                                        .add(Keys.ITEM_LORE, Arrays.asList(
                                                Text.of(TextColors.AQUA, "128 odun kaz."),
                                                Text.of(TextColors.GREEN, "Oduller:"),
